...
export const AccountSettings: React.FC = () => {
  ...
  }, [searchParams, setSearchParams, t, toast]); // 必要な依存関係を追加
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white/95 backdrop-blur-sm border border-white/20 rounded-2xl shadow-xl mb-6 overflow-hidden">
            ...
            <div className="p-6 sm:p-8">
              ...
              {state.activeTab === 'sessions' && <SessionsSettings />}
            </div>
          </div>
        </div>
      </div>
...
const ProfileSettings: React.FC = () => {
  ...
  const handleEmailChange = async () => {
    ...
    try {
      const response = await AuthAPI.requestEmailChange(token, {
        new_email: newEmail,
      });
      ...
      if (response.success) {
        toast.success(
          t(
            'settings.profile.email_change_request_sent',
            'メールアドレス変更リクエストを送信しました'
          ),
          t(
            'settings.profile.email_change_request_desc',
            '新しいメールアドレスに確認メールを送信しました。確認リンクをクリックすると変更が適用されます。'
          )
        );
        ...
        <div className="space-y-4">
          ...
          <div className="group">
            ...
            <p className="mt-2 text-xs text-gray-500">
              {t(
                'settings.profile.email_change_note',
                'メールアドレスの変更は安全性のため、別途お手続きが必要です'
              )}
            </p>
            <button
              type="button"
            ...
            <div className="relative">
              ...
              >
                ...
                <optgroup label="Europe">
                  ...
                  <option value="Europe/Reykjavik">
                    Europe/Reykjavik (UTC+0)
                  </option>
                  ...
                  <option value="Europe/Liechtenstein">
                    Europe/Liechtenstein (UTC+1)
                  </option>
                ...
                <optgroup label="North America">
                  ...
                  <option value="America/Calgary">
                    America/Calgary (UTC-7)
                  </option>
                ...
                <optgroup label="Africa">
                  ...
                  <option value="Africa/Alexandria">
                    Africa/Alexandria (UTC+2)
                  </option>
                  ...
                  <option value="Africa/Lilongwe">
                    Africa/Lilongwe (UTC+2)
                  </option>
                  <option value="Africa/Antananarivo">
                    Africa/Antananarivo (UTC+3)
                  </option>
                  <option value="Africa/Comoro">Africa/Comoro (UTC+3)</option>
                  <option value="Africa/Mayotte">Africa/Mayotte (UTC+3)</option>
                  <option value="Africa/Mauritius">
                    Africa/Mauritius (UTC+4)
                  </option>
                  <option value="Africa/Reunion">Africa/Reunion (UTC+4)</option>
                  <option value="Africa/Seychelles">
                    Africa/Seychelles (UTC+4)
                  </option>
                </optgroup>
            ...
            <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-2xl transform transition-all">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    {t(
                      'settings.profile.current_email',
                      '現在のメールアドレス'
                    )}
                  </label>
                  <input
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder={t(
                      'settings.profile.new_email_placeholder',
                      'new@email.com'
                    )}
                  />
                </div>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                  <p className="text-sm text-amber-800">
                    {t(
                      'settings.profile.email_change_warning',
                      '新しいメールアドレスに確認メールが送信されます。確認リンクをクリックすると変更が適用されます。'
                    )}
                  </p>
                </div>
              </div>
            ...
            <div className="group">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder={t(
                    'settings.security.password.current_password_placeholder',
                    '現在のパスワードを入力'
                  )}
                  required
                />
            ...
            <div className="group">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-4 pr-12 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-300 text-gray-900 placeholder-gray-400 font-light"
                  placeholder={t(
                    'settings.security.password.new_password_placeholder',
                    '8文字以上の新しいパスワード'
                  )}
                  minLength={8}
                  required
            ...
            <div className="group">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-4 pr-12 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-300 text-gray-900 placeholder-gray-400 font-light"
                  placeholder={t(
                    'settings.security.password.confirm_password_placeholder',
                    '新しいパスワードを再入力'
                  )}
                  minLength={8}
                  required
...
const SessionsSettings: React.FC = () => {
  ...
  const handleLogoutOtherSessions = async () => {
    const confirmed = await confirm({
      title: t(
        'settings.sessions.logout_confirm_title',
        'セッション終了の確認'
      ),
      message: t(
    ...
    try {
      ...
      if (response.success) {
        toast.success(
          t(
            'settings.sessions.logout_success',
            '他のセッションからログアウトしました'
          ),
          t(
            'settings.sessions.logout_success_desc',
            '他のデバイスでの認証が無効になりました'
          )
        );
      } else {
